...
var ImgMaxSizeService = (function () {
    ...
    ImgMaxSizeService.prototype.compressImage = function (file, maxSizeInMB, ignoreAlpha, logExecutionTime) {
        ...
        var compressedFileSubject = new rxjs_Subject.Subject();
    ...
    ImgMaxSizeService.ctorParameters = function () { return [
        { type: ng2Pica.ImgExifService, decorators: [{ type: _angular_core.Inject, args: [_angular_core.forwardRef(function () { return ng2Pica.ImgExifService; }),] },] },
    ]; };
...
var ImgMaxPXSizeService = (function () {
    ...
    ImgMaxPXSizeService.prototype.resizeImage = function (file, maxWidth, maxHeight, logExecutionTime) {
        var _this = this;
        if (logExecutionTime === void 0) { logExecutionTime = false; }
        var resizedFileSubject = new rxjs_Subject.Subject();
        this.timeAtStart = new Date().getTime();
        if (file.type !== "image/jpeg" && file.type !== "image/png") {
            //END OF RESIZE
            setTimeout(function () {
...
exports.ImgExifService = ng2Pica.ImgExifService;
