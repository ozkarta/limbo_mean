(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/Subject'), require('pica/dist/pica'), require('exif-js/exif')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs/Subject', 'pica/dist/pica', 'exif-js/exif'], factory) :
	(factory((global['ng2-pica'] = global['ng2-pica'] || {}),global.ng.core,global.rxjs_Subject,global.pica,global.EXIF));
}(this, (function (exports,_angular_core,rxjs_Subject,pica,EXIF) { 'use strict';
...
var Ng2PicaService = /** @class */ (function () {
    ...
    Ng2PicaService.prototype.resize = function (files, width, height, keepAspectRatio) {
        ...
        var resizedFile = new rxjs_Subject.Subject();
